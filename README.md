...
Data are fetched from an external server with the help of an API. Note, that all the words are grouped by collection and you can select only one single collection to be shown. You can both edit, delete and add words to the list (realised with React Context, but if you prefer MobX - just switch to mobx branch).
...
##
  ...
  \* _Weeks 26-34 Learning Project in [ITGirlSchool]_ 
   ...
   [Wordy]: <https://alenas-flashcards-app.netlify.app/>
   [Homepage]: <https://alenas-flashcards-app.netlify.app/#/>
   [Gamepage]: <https://alenas-flashcards-app.netlify.app/#/game>
